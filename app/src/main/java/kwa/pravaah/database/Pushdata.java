...
public class Pushdata extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... arg0) {
        ...
        try{
            ...
            URL url = new URL("https://script.google.com/macros/s/AKfycbzPAiy7yO2UL52lM9auXTLEnAM5V7nx3bdiDOw3iQlws0fft2M/exec");
            JSONObject postDataParams = new JSONObject();
            String id= "1Cntx7-iHTVpE2ePqkh-QcrR1iT4Y_kT7f7xRMXKbPVQ";
